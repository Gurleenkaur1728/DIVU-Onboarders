...
export default function Modules() {
  ...
  const [modules, setModules] = useState([
    {
      id: 1,
      title: "Name of Module 1",
      description: "Short intro to our culture and ways of working.",
      assigned: "00-00-0000",
      duration: "10 min",
      status: "completed",
      progress: 100,
    },
    {
      ...
      description: "Security basics and acceptable use policy.",
      assigned: "00-00-0000",
      duration: "15 min",
      status: "available",
      progress: 0,
    ...
    {
      id: 3,
      title: "Name of Module 3",
      description: "Tools you’ll use daily and how to access them.",
      assigned: "00-00-0000",
      duration: "12 min",
      status: "in-progress",
      progress: 45,
    ...
    {
      id: 4,
      title: "Name of Module 4",
      description: "HR handbooks and benefits overview.",
      assigned: "00-00-0000",
      duration: "8 min",
      status: "completed",
      progress: 100,
    ...
    {
      id: 5,
      title: "Name of Module 5",
      description: "Health & safety training.",
      assigned: "00-00-0000",
      duration: "20 min",
      status: "available",
      progress: 0,
    ...
    {
      id: 6,
      title: "Name of Module 6",
      description: "Team-specific onboarding.",
      assigned: "00-00-0000",
      duration: "25 min",
      status: "locked",
      progress: 0,
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        <div className="flex items-center justify-between bg-emerald-950/90 rounded-md px-4 py-3 mb-4 shadow">
          ...
          <div className="flex gap-2">
            <Link
              to="/checklist"
              className="px-3 py-1.5 rounded bg-emerald-700 text-white text-sm font-semibold hover:bg-emerald-600"
            >
              Checklist
            </Link>
            <button className="px-3 py-1.5 rounded bg-emerald-300 text-emerald-950 text-sm font-bold">
              Modules
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {modules.map((m) => (
            ...
            >
              ...
              {/* Description */}
              <p className="text-sm text-emerald-950/80 mb-3">
                {m.description}
              </p>
