...
export default function Home() {
  ...
  useEffect(() => {
    fetchContent("home").then(setContent);
  }, []);
  ...
  return (
    ...
    >
      <Sidebar role={ROLES.USER} active="home" />
        ...
        <div className="bg-white/95 rounded-2xl shadow-2xl p-10 max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h1 className="text-4xl font-extrabold text-emerald-900 mb-6">
              {content?.title || "Welcome to DIVU"}
            </h1>
            <p className="text-lg text-gray-700 leading-relaxed whitespace-pre-line">
              {content?.subtitle ||
                "We are excited to have you join our team of curious, driven, and forward-thinking professionals!"}
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <img
              src={content?.media_url || "/placeholder.jpg"}
              alt="Home"
